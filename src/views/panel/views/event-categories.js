...
class Admins extends React.Component {
    ...
    async _getList() {
        let c = new WebClient();
        await c.post("get-event-category-list.json", {})
    ...
    _delete() {
        ...
        let c = new WebClient();
        c.post("delete-event-category.json", {id: this.state.deletedItemID})
        .then(({status, message, data}) => {
    ...
    render() {
        ...
        return (
            ...
            <Breadcrumbs
                marginBottom=""
                breadCrumbTitle="Etkinlik Kategorileri"
                    ...
                    <Card>
                        ...
                        <Formik
                            ...
                            onSubmit={(values, {setSubmitting, resetForm, setError, setFieldValue, setFieldError}) => {
                                    ...
                                    let c = new WebClient();
                                    c.post("add-event-category.json", {
                                        id: item?.id ?? -1,
                                        title: values.title,
