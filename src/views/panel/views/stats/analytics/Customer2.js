...
class Productorders extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      options: {
        ...
        colors: [this.props.primaryLight, this.props.dangerLight],
        fill: {
          type: "gradient",
          gradient: {
            gradientToColors: [
        ...
        labels: ["Sipariş Sayısı", "Kayıt Sayısı"]
      },
      series: [0, 0]
    }
  }
  ...
  async _getReports(type, start, end, phone_match, tckn_match) {
    ...
    let c = new WebClient();
    await c.post("get-order-by-user.json", {type, start, end, phone_match, tckn_match})
  ...
  render() {
    ...
    return (
      <Card>
        <CardHeader>
          <CardTitle>Yeni Kayıt Sipariş Oranı</CardTitle>
          <UncontrolledDropdown>
        ...
        <ListGroup flush>      
          <ListGroupItem className="d-flex justify-content-between">
            <div className="item-info">
              ...
              />
              <span className="text-bold-600 ml-2">Yeni Kayıt Sayısı</span>
            </div>
          ...
          <ListGroupItem className="d-flex justify-content-between">
            <div className="item-info">
              ...
              />
              <span className="text-bold-600 ml-2">Sipariş Sayısı (Yeni Kaydolan Kullanıcıların Yaptığı)</span>
            </div>
            <div className="product-result">
