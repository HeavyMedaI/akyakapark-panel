...
class AvgSessions extends React.Component {
  ...
  async _getReports(start, end, phone_match, tckn_match) {
    ...
    let c = new WebClient();
    await c.post("get-daily-installs.json", {start, end, phone_match, tckn_match})
          ...
          <Row className="pb-50">
            <Col md="12">
              <div className="session-info">
                <p className="text-bold-700 mb-75">Günlük Uygulama Yükleme Sayıları</p>
              </div>
              <Col md="12">
                <Row>
