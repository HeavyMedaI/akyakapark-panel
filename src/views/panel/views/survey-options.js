...
class Admins extends React.Component {
    ...
    async _getList() {
        ...
        let c = new WebClient();
        await c.post("get-survey-option-list.json", {nid})
    ...
    _delete() {
        ...
        let c = new WebClient();
        c.post("delete-survey-option.json", {id: this.state.deletedItemID})
        .then(({status, message, data}) => {
    ...
    render() {
        ...
        return (
            ...
            <Breadcrumbs
                marginBottom=""
                showBackButton={true}
                breadCrumbTitle="Anket Seçenekleri"
