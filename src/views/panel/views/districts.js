...
class Admins extends React.Component {
    ...
    async _getList() {
        ...
        let c = new WebClient();
        await c.post("get-district-list.json", {nid})
    ...
    _delete() {
        ...
        let c = new WebClient();
        c.post("delete-district.json", {id: this.state.deletedItemID})
        .then(({status, message, data}) => {
                    ...
                    <Card>
                        ...
                        >
                            ...
                            <Form noValidate={true} autoComplete="off">
                                ...
                                <Col sm="12">
                                    <FormGroup>
                                    <CLabel required for="nameVertical">İlçe Adı</CLabel>
                                    <Field
