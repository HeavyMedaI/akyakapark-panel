...
class Admins extends React.Component {
    ...
    _getResources() {
        ...
        .then(({status, message, data}) => {
            ...
            if (status) {
                this.setState({venue_categories: data.venue_categories})
            }
        })
    }      
    ...
    async _getList() {
        let c = new WebClient();
        await c.post("get-venue-list.json", {})
        .then(({status, message, data}) => {
            ...
            columns = [  
                ...
                },   
                {
                    ...
                    cell: params => {
                        ...
                        <Button
                            className="btn"
                            onClick={() => { history.push(`/venue-images/${params.id}`) }}
                            color="primary"
                        >
                            {params.image_count}
                        </Button>          
    ...
    _delete() {
        ...
        let c = new WebClient();
        c.post("delete-venue.json", {id: this.state.deletedItemID})
        .then(({status, message, data}) => {
    ...
    render() {
        ...
        const { list, finished, addOrEdit, item, editing, base64, venue_categories } = this.state
                    ...
                    <Card>
                        ...
                        >
                            ...
                            <Form noValidate={true} autoComplete="off">
                                ...
                                <Col sm="12">
                                    <FormGroup>
                                    <CLabel required for="nameVertical">Tesis Adı</CLabel>
                                    <Field
                                ...
                                <Col sm="12">
                                    <FormGroup>
                                    <CLabel required for="EmailVertical">Tesis Kategorisi</CLabel>
                                    <Select
                                ...
                                <Col sm="12" className="mb-2">
                                    <CLabel required for="nameVertical">Tesis Hakkında</CLabel>
                                    <SunEditor 
                                        name="about"
                                        setOptions={{
                                            height: 160,
                                ...
                                <Col sm="12">
                                    <FormGroup>
                                    <CLabel required for="nameVertical">Dış Bağlantı</CLabel>
                                    <Field
