...
class Admins extends React.Component {
    ...
    async _getList() {
        let c = new WebClient();
        await c.post("get-profession-list.json", {})
    ...
    _delete() {
        ...
        let c = new WebClient();
        c.post("delete-profession.json", {id: this.state.deletedItemID})
        .then(({status, message, data}) => {
                    ...
                    <Card>
                        ...
                        >
                            ...
                            <Form noValidate={true} autoComplete="off">
                                ...
                                <Col sm="12">
                                    <FormGroup>
                                    <CLabel required for="nameVertical">Meslek Adı</CLabel>
                                    <Field
