...
class Admins extends React.Component {
    ...
    async _getList() {
        let c = new WebClient();
        await c.post("get-city-list.json", {})
        .then(({status, message, data}) => {
            ...
            columns = [    
                ...
                {
                    name: "İlçeler",
                    selector: "district_count",
                    width: "100px",
                    center: true,
                    cell: params => {
                        return (
                        <Button
                            onClick={() => { history.push(`/districts/${params.id}`) }}
                            color="primary"
                            style={{ width: "100%", paddingLeft: 0, paddingRight: 0 }}
                        >
                            {params.district_count}
                        </Button>          
                        )
                    }
                },                                                             
    ...
    _delete() {
        ...
        let c = new WebClient();
        c.post("delete-city.json", {id: this.state.deletedItemID})
        .then(({status, message, data}) => {
    ...
    render() {
        ...
        return (
            ...
            <Breadcrumbs
                marginBottom=""
                breadCrumbTitle="Şehir ve İlçeler"
                    ...
                    <Card>
                        ...
                        >
                            ...
                            <Form noValidate={true} autoComplete="off">
                                ...
                                <Col sm="12">
                                    <FormGroup>
                                    <CLabel required for="nameVertical">Şehir Adı</CLabel>
                                    <Field
