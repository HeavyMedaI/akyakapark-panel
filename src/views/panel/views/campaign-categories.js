...
class Admins extends React.Component {
    ...
    async _getList() {
        let c = new WebClient();
        await c.post("get-campaign-category-list.json", {})
    ...
    _delete() {
        ...
        let c = new WebClient();
        c.post("delete-campaign-category.json", {id: this.state.deletedItemID})
        .then(({status, message, data}) => {
    ...
    render() {
        ...
        return (
            ...
            <Breadcrumbs
                marginBottom=""
                breadCrumbTitle="Kampanya Kategorileri"
                    ...
                    <Card>
                        ...
                        <Formik
                            ...
                            onSubmit={(values, {setSubmitting, resetForm, setError, setFieldValue, setFieldError}) => {
                                    ...
                                    let c = new WebClient();
                                    c.post("add-campaign-category.json", {
                                        id: item?.id ?? -1,
                                        title: values.title,
