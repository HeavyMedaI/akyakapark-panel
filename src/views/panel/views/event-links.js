...
class Admins extends React.Component {
    ...
    async _getList() {
        ...
        let c = new WebClient();
        await c.post("get-event-link-list.json", {nid})
    ...
    _delete() {
        ...
        let c = new WebClient();
        c.post("delete-event-link.json", {id: this.state.deletedItemID})
        .then(({status, message, data}) => {
    ...
    render() {
        ...
        return (
            ...
            <Breadcrumbs
                marginBottom=""
                showBackButton={true}
                breadCrumbTitle="Etkinlik Ekstra Linkleri"
