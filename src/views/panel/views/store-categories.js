...
class StoreCategories extends React.Component {
    ...
    async _getList() {
        let c = new WebClient();
        await c.post("get-store-category-list.json", {})
    ...
    _delete() {
        ...
        let c = new WebClient();
        c.post("delete-store-category.json", {id: this.state.deletedItemID})
        .then(({status, message, data}) => {
                    ...
                    <Card>
                        ...
                        <Formik
                            ...
                            onSubmit={(values, {setSubmitting, resetForm, setError, setFieldValue, setFieldError}) => {
                                    ...
                                    let c = new WebClient();
                                    c.post("add-store-category.json", {
                                        id: item?.id ?? -1,
                                        title: values.title,
...
export default connect(msp)(StoreCategories)
