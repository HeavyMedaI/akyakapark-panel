...
class StoreImages extends React.Component {
    ...
    async _getList() {
        ...
        let c = new WebClient();
        await c.post("get-store-image-list.json", {nid})
    ...
    _delete() {
        ...
        let c = new WebClient();
        c.post("delete-store-image.json", {id: this.state.deletedItemID})
        .then(({status, message, data}) => {
    ...
    render() {
        ...
        return (
            ...
            <Breadcrumbs
                marginBottom=""
                showBackButton={true}
                breadCrumbTitle="Tesis Resimleri"
...
export default connect(msp)(StoreImages)
