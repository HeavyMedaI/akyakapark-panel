...
const navigationConfig = [
  ...
  {
    id: 'user-receipts',
    title: 'Müşteri Fişleri',
    icon: <Feather.Umbrella size={20} />,
    type: "item",
    permissions: ["super-admin"],
    navLink: '/user-receipts'
  },
  {
    type: "groupHeader",
    groupTitle: "MAĞAZA & ETKİNLİKLER",
    permissions: ["company-admin", "super-admin"],
  },
  {
    id: 'events',
  ...
  {
    id: 'valid-stores',
    title: 'Geçerli Mağazalar',
    icon: <Feather.ShoppingBag size={20} />,
    type: "item",
    permissions: ["super-admin"],
    navLink: '/valid-stores'
  },
  {
    id: 'contact-info',
